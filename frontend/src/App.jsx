...
function BotaoWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-4 z-50 flex items-center justify-center bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full shadow-xl transition-all hover:scale-105"
    >
